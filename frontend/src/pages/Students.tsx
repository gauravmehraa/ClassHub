      ...
      </div>
      {
        ...
        <div className="flex flex-col gap-4 m-4 sm:m-8">
          { Object.keys(students).length === 0?
            <div className='font-semibold text-2xl flex gap-2 items-center my-auto mx-auto'> <MdOutlineSearchOff className='text-classhub-purple w-8 h-8'/> No students </div>:
