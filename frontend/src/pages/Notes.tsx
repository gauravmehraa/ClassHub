    ...
    <div className="flex flex-col text-black py-4 sm:py-8 overflow-auto max-h-screen w-full">
      {
        ...
        <div className="flex flex-col gap-4 m-4 sm:m-8">
          ...
          <Link to ="add" className="mx-auto btn btn-lg border-none bg-classhub-purple text-white hover:bg-white hover:text-black">Add Note</Link>
          : null }
          { Object.keys(notes).length === 0?
            <div className='font-semibold text-2xl flex gap-2 pt-8 items-center my-auto mx-auto'> <MdSearchOff className='text-classhub-purple w-8 h-8'/> No notes </div>:
