...
const Navbar = () => {
  ...
  const buttonClass = "w-11/12 justify-left items-center flex gap-4 px-6 py-3 rounded-md"
  ...
  return (
    ...
    <nav className='max-h-screen min-h-screen border-r-0 border-slate-400 min-w-72 max-w-72 bg-white md:flex flex-col text-black font-roboto hidden'> 
      ...
      <div className='mt-auto flex flex-col items-center gap-6 pb-16 font-semibold'>
